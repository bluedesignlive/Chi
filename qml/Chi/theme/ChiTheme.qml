...
Item {
    ...
    function _isSeedColor(c) {
        return Math.abs(c.r - seed.r) < 0.02 && Math.abs(c.g - seed.g) < 0.02 && Math.abs(c.b - seed.b) < 0.02;
    }
    ...
    function setDarkMode(dark) {
        _chiBackend.isDarkMode = dark;
    }
    function setPrimaryColor(c) {
        _chiBackend.primaryColor = c.toString();
    }
    function toggleDarkMode() {
        _chiBackend.isDarkMode = !_chiBackend.isDarkMode;
    }
    ...
    function _genDark(p) {
        ...
        return {
            primary: lt.toString(),
            onPrimary: Qt.darker(p, 1.8).toString(),
