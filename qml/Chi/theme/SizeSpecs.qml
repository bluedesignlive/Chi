...
QtObject {
    ...
    readonly property var extendedFab: ({
        small:  { height: 44, iconSize: 24, leadingSpace: 12, trailingSpace: 16, radius: 12 },
        medium: { height: 56, iconSize: 24, leadingSpace: 16, trailingSpace: 20, radius: 16 },
        large:  { height: 96, iconSize: 36, leadingSpace: 30, trailingSpace: 24, radius: 28 }
    })
...
readonly property var splitButton: ({
    ...
    readonly property var buttonGroup: ({
        xsmall: { height: 32, betweenSpace: 18 },
        small:  { height: 40, betweenSpace: 12 },
        medium: { height: 56, betweenSpace: 8 },
        large:  { height: 96, betweenSpace: 8 },
        xlarge: { height: 80, betweenSpace: 18 }
    })
...
readonly property var connectedButtonGroup: ({
    ...
    readonly property var tag: ({
        small:  { height: 20, fontSize: 11, iconSize: 12, padding: 6, closeIconOffset: 4 },
        medium: { height: 24, fontSize: 12, iconSize: 14, padding: 8, closeIconOffset: 4 },
        large:  { height: 32, fontSize: 14, iconSize: 18, padding: 12, closeIconOffset: 4 }
    })
    ...
    readonly property var numberField: ({
        small:  { height: 32, width: 96,  fontSize: 13, buttonSize: 28, iconSize: 16 },
        medium: { height: 40, width: 120, fontSize: 14, buttonSize: 36, iconSize: 20 },
        large:  { height: 48, width: 152, fontSize: 16, buttonSize: 44, iconSize: 24 }
    })
    ...
    readonly property var slider: ({
        xs:   { trackH: 16, handleH: 44, outerR: 16, iconSz: 0,   innerR: 2, gap: 6, endPad: 4, stopDotSz: 4 },
        small:{ trackH: 24, handleH: 44, outerR: 8,  iconSz: 0,   innerR: 2, gap: 6, endPad: 4, stopDotSz: 4 },
        medium:{ trackH: 40, handleH: 52, outerR: 12, iconSz: 24, innerR: 2, gap: 6, endPad: 4, stopDotSz: 4 },
        large:{ trackH: 56, handleH: 68, outerR: 16, iconSz: 24, innerR: 2, gap: 6, endPad: 4, stopDotSz: 4 },
        xl:   { trackH: 96, handleH: 108,outerR: 28, iconSz: 32, innerR: 2, gap: 6, endPad: 4, stopDotSz: 4 }
    })
    ...
    readonly property var checkbox: ({
        small:  { boxSize: 16, iconSize: 14, fontSize: 13, gap: 8,  touchTarget: 40 },
        medium: { boxSize: 20, iconSize: 18, fontSize: 14, gap: 12, touchTarget: 40 },
        large:  { boxSize: 24, iconSize: 22, fontSize: 16, gap: 16, touchTarget: 40 }
    })
    ...
    readonly property var radioButton: ({
        small:  { outerSize: 16, innerSize: 8,  fontSize: 13, gap: 8,  touchTarget: 40 },
        medium: { outerSize: 20, innerSize: 10, fontSize: 14, gap: 12, touchTarget: 40 },
        large:  { outerSize: 24, innerSize: 12, fontSize: 16, gap: 16, touchTarget: 40 }
    })
    ...
    readonly property var switch_: ({
        small:  { trackH: 20, trackW: 44, handleSize: 16, iconSize: 12, handleRadius: 100, touchTarget: 40 },
        medium: { trackH: 28, trackW: 52, handleSize: 20, iconSize: 14, handleRadius: 100, touchTarget: 40 },
        large:  { trackH: 36, trackW: 60, handleSize: 28, iconSize: 16, handleRadius: 100, touchTarget: 48 }
    })
...
readonly property var searchBar: ({
    small: {
        height: 44, ch: 44, fontSize: 14, iconSize: 20, is: 20,
        leadingPad: 12, horizPad: 12, hp: 12,
        as: 32, isp: 8, sih: 44,
        typo: "labelMedium", subTypo: "bodySmall"
    },
    medium: {
        height: 56, ch: 56, fontSize: 16, iconSize: 24, is: 24,
        leadingPad: 16, horizPad: 16, hp: 16,
        as: 40, isp: 12, sih: 52,
        typo: "labelLarge", subTypo: "bodyMedium"
    },
    large: {
        height: 64, ch: 64, fontSize: 18, iconSize: 28, is: 28,
        leadingPad: 20, horizPad: 20, hp: 20,
        as: 48, isp: 16, sih: 60,
        typo: "titleSmall", subTypo: "bodyMedium"
    }
})
    ...
    readonly property var menuItem: ({
        small:  { height: 36,  iconSize: 20, chevronSize: 16, leadingSpace: 12, trailingSpace: 12, supportHeight: 0,   radius: 8, dividerMargin: 9 },
        medium: { height: 48,  iconSize: 24, chevronSize: 20, leadingSpace: 16, trailingSpace: 16, supportHeight: 52,  radius: 12, dividerMargin: 9 },
        large:  { height: 56,  iconSize: 24, chevronSize: 20, leadingSpace: 16, trailingSpace: 16, supportHeight: 64,  radius: 12, dividerMargin: 9 }
    })
    ...
    readonly property var tooltip: ({
        small:  { height: 24, fontSize: 11, iconSize: 16, cornerRadius: 4, horizPad: 8,  vertPad: 4  },
        medium: { height: 32, fontSize: 12, iconSize: 18, cornerRadius: 8, horizPad: 12, vertPad: 6  },
        large:  { height: 40, fontSize: 14, iconSize: 20, cornerRadius: 12, horizPad: 16, vertPad: 8 }
    })
