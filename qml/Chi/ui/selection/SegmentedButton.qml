...
Item {
    ...
    function _isSelected(idx) {
        return multiSelect ? selectedIndices.indexOf(idx) !== -1 : selectedIndex === idx;
    }
    ...
    function _activate(idx) {
        ...
        if (multiSelect) {
            ...
            if (pos !== -1) {
                if (arr.length > 1)
                    arr.splice(pos, 1);   // keep at least 1
            } else {
                arr.push(idx);
    ...
    Row {
        ...
        Repeater {
            ...
            Item {
                ...
                readonly property bool hasText: modelData.text !== undefined && modelData.text !== ""
                ...
                implicitWidth: _hPad + _checkW + _checkGap + _iconW + _iconGapW + _labelText.implicitWidth + _hPad
                height: _touchH
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        color: seg.isSel ? Qt.rgba(colors.onSecondaryContainer.r, colors.onSecondaryContainer.g, colors.onSecondaryContainer.b, 1) : Qt.rgba(colors.onSurface.r, colors.onSurface.g, colors.onSurface.b, 1)

                        opacity: !root.enabled ? 0 : segMa.pressed ? 0.10 : (seg.activeFocus ? 0.10 : (segMa.containsMouse ? 0.08 : 0))

                        Behavior on opacity {
                            NumberAnimation {
                                duration: segMa.pressed ? motion.durationFast : motion.durationMedium
                                easing.type: Easing.OutCubic
                            }
                        }
                    ...
                    Row {
                        ...
                        Item {
                            width: (seg.isSel && (seg.hasIcon || seg.hasText)) ? _iconGap : 0
                            height: 1
                        ...
                        Text {
                            ...
                            color: seg.isSel ? colors.onSecondaryContainer : colors.onSurface
