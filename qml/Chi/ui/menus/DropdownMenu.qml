            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        anchors.margins: 1
                        radius: 8
                        color: _subM.containsMouse || index === root._highlightIdx ? Qt.alpha(root.colors.onSurface, 0.08) : "transparent"
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        ...
                        anchors.margins: 1
                        radius: 8
                        color: _dropMouse.containsMouse || index === root._highlightIdx ? Qt.alpha(root.colors.onSurface, 0.08) : "transparent"
