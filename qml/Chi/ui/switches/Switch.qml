...
Item {
    ...
    Rectangle {
        ...
        border.color: !root.enabled ? Qt.rgba(colors.onSurface.r, colors.onSurface.g, colors.onSurface.b, 0.12) : colors.outline
        ...
        Item {
            ...
            Item {
                ...
                x: root.checked ? parent.width - width + 12 * s : (root.showIcon ? -12 * s : -16 * s)
                ...
                Rectangle {
                    ...
                    opacity: !root.enabled ? 0 : (mouseArea.pressed ? 0.12 : (root.activeFocus ? 0.12 : (mouseArea.containsMouse ? 0.08 : 0)))
                    Behavior on opacity {
                        NumberAnimation {
                ...
                Rectangle {
                    ...
                    width: {
                        ...
                        if (root.enabled && mouseArea.pressed)
                            baseW = 28;
                        return baseW * s;
                    }
                    height: width
