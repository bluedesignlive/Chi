                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            spacing: 12
                            Text {
                                text: model.icon || "description"
                                font.family: iconFamily
                                font.pixelSize: 20
                                color: row.selected ? colors.onSecondaryContainer : colors.primary
                                anchors.verticalCenter: parent.verticalCenter
                            }
                            Text {
                                text: model.name
                                font.family: fontFamily
                                font.pixelSize: 14
                                color: row.selected ? colors.onSecondaryContainer : colors.onSurface
                                anchors.verticalCenter: parent.verticalCenter
                            }
                        }
                    }
